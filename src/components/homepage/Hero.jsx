  ...
  return (
    <div>
        <section className="bg-white dark:bg-gray-900">
            <div 
                className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 
                lg:grid-cols-12"
            >
                <div className="mr-auto place-self-center lg:col-span-7">
                    <h1 
                        className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight 
                        leading-none md:text-5xl xl:text-6xl dark:text-white"
                    >
                        Group 6 Medical Group New Patient Appointments
                    </h1>
                    <p 
                        className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 
                        md:text-lg lg:text-xl dark:text-gray-400"
                    >
                        Group 6 Medical Group's care teams of doctors, physician assistants and 
                        nurse practitioners are available 24/7 for all your healthcare 
                        questions and needs. Whether you're not feeling well, 
                        suffer from a chronic condition or just need medical advice, 
                        we’ll help determine the right care for you. We provide convenient 
                        virtual and in-office appointments, so always ask us first to get the care 
                        you need.
                    </p>
                    <a 
